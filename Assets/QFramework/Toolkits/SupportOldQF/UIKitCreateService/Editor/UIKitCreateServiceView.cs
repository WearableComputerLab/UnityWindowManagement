    ...
    public class UIKitCreateServiceView
    {
        ...
        public void OnCreateUIPanelClick()
        {
            ...
            if (!string.IsNullOrEmpty(panelName))
            {
                ...
                {
                    EditorUtility.DisplayDialog("error", "UI interface already exists:{0}".FillFormat(panelPrefabPath), "OK");
                ...
                {
                    EditorUtility.DisplayDialog("error", "Test scene already exists:{0}".FillFormat(fullScenePath), "OK");
        ...
        class LocaleText
        {
            public static string CreateUIPanel => Language.IsChinese ? "Create UI Panel" : "Create UI Panel";
        }
