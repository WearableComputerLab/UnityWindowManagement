...
{
    public bool updateScaleForcely { get; internal set; }
    ...
    public string getParWinTitle(string x)
    {
         partialWindowTitle = x;
    ...
    void Start()
    {
        ...
        rect = boxCollider.GetComponent<RectTransform>();
    ...
    private void OnMouseDown()
    {
        ...
        int window_width = window.rawWidth;             
        int window_height = window.rawHeight;        
        int x = window.x;
        int y = window.y;
       ...
       /*Debug.Log("x:" + x);
        ...
        Debug.Log(window.rawWidth);
        Debug.Log("Height: " + window_height);
       */

        mousePos.x = x + (window_width / 2) + (window_width * mousePos.x);
        mousePos.y = (window_height / 2) - (window_height * mousePos.y) + y;
        //Debug.Log("Mouse x: " + (int)mousePos.x);
        //Debug.Log("Mouse y: " + (int)mousePos.y);
        //Debug.Log("Window Name: " + window.title);


        SetCursorPos((int)mousePos.x, (int)mousePos.y);
        MouseHookHelper.mouse_event(MouseHookHelper.MOUSEEVENTF_LEFTDOWN | MouseHookHelper.MOUSEEVENTF_LEFTUP,0 ,0 , 0, 0);
        MouseHookHelper.mouse_event (MouseHookHelper.MOUSEEVENTF_LEFTDOWN | MouseHookHelper.MOUSEEVENTF_LEFTUP, 0, 0, 0, 0 );

        //MouseHookHelper.mouse_event(MouseHookHelper.MOUSEEVENTF_RIGHTDOWN | MouseHookHelper.MOUSEEVENTF_RIGHTUP, 0, 0, 0, 0);
